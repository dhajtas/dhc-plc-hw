...
#ifndef portW5200		// Definition in freeRTOSBoardDefs.h w5200.h and w5200.c are used.
...
/**
@brief	 __DEF_IINCHIP_MAP_xxx__ : define memory map for W5100
*/
#define __DEF_IINCHIP_MAP_BASE__	0x8000
#define COMMON_BASE					0x0000

#define __DEF_IINCHIP_MAP_TXBUF__ (COMMON_BASE + 0x4000) /* Internal Tx buffer address of the W5100 */
#define __DEF_IINCHIP_MAP_RXBUF__ (COMMON_BASE + 0x6000) /* Internal Rx buffer address of the W5100 */
...
void	 IINCHIP_init(void); // reset W5100 - First call to make
...
void	saveSUBR(uint8_t *addr);	// pointer to a 4 byte array responsible to set the SubnetMask address
void	setSUBR(void);
void	clearSUBR(void);
