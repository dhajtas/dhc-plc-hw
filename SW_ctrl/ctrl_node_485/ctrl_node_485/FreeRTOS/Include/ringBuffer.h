...
typedef struct
{
	uint16_t volatile count;	/**< Number of bytes currently stored in the buffer. */
	uint8_t volatile * in;		/**< Current storage location in the circular buffer. */
	uint8_t volatile * out;		/**< Current retrieval location in the circular buffer. */
