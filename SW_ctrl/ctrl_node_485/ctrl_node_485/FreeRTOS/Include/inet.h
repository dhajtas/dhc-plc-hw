...
#define TZ_MELBOURNE		(int32_t)36000		// Set the time zone. 10 * ONE_HOUR
...
/* MACRAW Definitions */
#define MACRAW_PREFERRED_SOCKET	0			// THIS IS VERY SPECIAL. Only Socket 0 can do MAC RAW mode.
...
#define NTP_REFRESH_PERIOD		7200	// Refresh every 7200 seconds (2 hours), or 300 seconds (5 minutes).
#define NTP_TIMEOUT				1000	// Timeout waiting for NTP response in system milliseconds.
...
typedef uint8_t SOCKET;	// IINCHIP W5x00 Socket in use. < MAX_SOCK_NUM if not using uIP.
