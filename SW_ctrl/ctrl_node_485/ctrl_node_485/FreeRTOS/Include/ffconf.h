...
#define _FS_MINIMIZE	0	/* 0 to 3 */ // ArduSat Client 1
...
#define	_USE_STRFUNC	2	/* 0:Disable or 1-2:Enable */ // ArduSat Client 1
/* To enable string functions, set _USE_STRFUNC to 1 or 2. */


#define	_USE_MKFS		1	/* 0:Disable or 1:Enable */ // ArduSat Client 0
/* To enable f_mkfs function, set _USE_MKFS to 1 and set _FS_READONLY to 0 */


#define	_USE_FASTSEEK	0	/* 0:Disable or 1:Enable */
/* To enable fast seek feature, set _USE_FASTSEEK to 1. */
/* Enabling this only works with -O2 Too many registers used for -Os or -O3 */
...
#define	_USE_ERASE	1	/* 0:Disable or 1:Enable */ // ArduSat Client 0
...
/  access results incorrect behaviour, the _WORD_ACCESS must be set to 0.
/  If it is not the case, the value can also be set to 1 to improve the
/  performance and code size.
/
/  AVR ATmega supports word access.
*/
...
/   1: Enable reentrancy. Also user provided synchronisation handlers,
/      ff_req_grant, ff_rel_grant, ff_del_syncobj and ff_cre_syncobj
/      function must be added to the project. */


#define	_FS_LOCK		4	/* 0:Disable or >=1:Enable */
/* To enable file lock control feature, set _FS_LOCK to 1 or greater (2 for file copy).
   The value defines how many files can be opened simultaneously.
	_FS_LOCK must be 0 if _FS_READONLY on (read-only cfg).
   */
